...
In this subsection we give an extension of $\foe$ with a unary fixed point operator %. This extension is known in the literature as FO(LFP$^1$) but 
that we will call $\mufoe$ %. In this dissertation we focus on \unfolfp, which we denote as $\mufoe$
