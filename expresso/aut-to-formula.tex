...
% that, given a weak $(\prop,X)$-automaton $\aut$ gives an equivalent  formula $\xi_{\aut} \in \AFMC$ in which all occurrences of variables in $X$ are positive. Moreover if $\aut$ is continuous-weak, then $\xi_{\aut} \in \contAFMC$.
\end{claimfirst}
