...
\newcommand{\mucaML}{\ensuremath{\mu_{a}\textup{ML}}\xspace}
\newcommand{\nmucaML}{\ensuremath{\mu_{na}\textup{ML}}\xspace}
\newcommand{\rmucaML}{\ensuremath{\mu_{a}^{-}\textup{ML}}\xspace}
\newcommand{\rnmucaML}{\ensuremath{\mu_{na}^{-}\textup{ML}}\xspace}
\newcommand{\mucML}{\ensuremath{\mu_{c}\textup{ML}}\xspace}
\newcommand{\lmuML}{\ensuremath{\mu\ML^{\lor}}\xspace}
\newcommand{\lmucML}{\ensuremath{\mu_{c}\textup{ML}^{\lor}}\xspace}
\newcommand{\lnmucML}{\ensuremath{\mu_{nc}\textup{ML}^{\lor}}\xspace}
...
Proof~of~{#1}.\ }]}{\hspace*{\fill} {\qed}\end{trivlist}}
...
%	\def\@currentlabel{\theclaimcounter}%
%	\begin{trivlist}\item[]{\sc Claim~\arabic{claimcounter}.~}}
%	{\end{trivlist}}
...
% \newcommand*\sepsection{%
%   \begin{center}
%   	\small\vspace{-5pt} % ugly, sorry :(
%     $\star\quad\star\quad\star$
%     \vspace{-5pt} % ugly, sorry :(
%   \end{center}}
